...
public class MurderOfCrows {
	...
	private void findTheDiamond() {
		/*
		 * Your mission: One of the Crows has eaten the diamond. You need to search through the stomach of each Crow, 
		 * then print the name of the guilty Crow.
		 */
		int numCrowsFoundInnocent = 0;
		for (Crow crow : theMurder) {
			...
			if (crowStomachContents.contains("diamond")) {
				...
				System.out.println("Number of crows found innocent: " + numCrowsFoundInnocent);
				break;
			} else { 
				numCrowsFoundInnocent += 1;
			}
		}
	}
